# Generated by Powerlevel10k configuration wizard on 2022-10-14 at 00:34 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    # cute_fancy              # change prompt segment to 'cute_fancy' defined on line 1682, run `p10k help segment` for further detail
  )
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='(ﾉ◕ヮ◕)ﾉ*:･ﾟ✧ ❯'
